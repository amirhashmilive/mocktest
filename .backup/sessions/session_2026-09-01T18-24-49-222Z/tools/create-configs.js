...
const configs = [
  ...
  {
    id: "foundation", name: "Foundation & Core Subjects (Live + Recorded)", icon: "📖", color: "#38b000",
  ...
  {
    id: "teaching", name: "Teaching Exams (CTET, State TET, BPSC TRE 4.0)", icon: "🧑‍🏫", color: "#7209b7",
    categoryGroup: "Teaching & Academics",
    description: "TET (CTET/STET) & BPSC TRE 4.0 (Class 1-5, 6-8, 9-10)",
    papers: [
    ...
    subjects: [
      ...
      { id: "gs", name: "General Studies & Teacher Subject", weight: 0.30, topics: ["Math", "Science", "Social Science", "GK"] },
      { id: "language", name: "Language Aptitude", weight: 0.20, topics: ["Grammar", "Comprehension", "Pedagogy of Language"] },
      { id: "teaching_methods", name: "Teaching Methods & Communication", weight: 0.20, topics: ["Classroom Management", "Evaluation", "Pedagogy"] }
    ],
    difficultyDistribution: { easy: 0.25, moderate: 0.50, difficult: 0.25 },
    levels: { C: "Beginner", B: "Intermediate", A: "Advanced", "A+": "Expert", "A++": "Elite" }
  },
  {
    id: "ugc-net", name: "UGC NET / JRF (All 83 Subjects)", icon: "🎓", color: "#9d4edd",
    categoryGroup: "Higher Education & Research",
    description: "University Grants Commission National Eligibility Test — Paper-I (Teaching & Research Aptitude) + Paper-II (Subject-Specific)",
    papers: [
      { id: "paper1", name: "Paper I - Teaching & Research Aptitude", questions: 50, timeLimit: 60, questionTypes: ["MCQ"], negativeMarking: false, marksPerQuestion: 2, negativeMarks: 0, description: "Teaching Aptitude, Research, Data Interpretation, Higher Ed, ICT, Communication" },
      { id: "paper2", name: "Paper II - Subject Paper", questions: 100, timeLimit: 120, questionTypes: ["MCQ"], negativeMarking: false, marksPerQuestion: 2, negativeMarks: 0, description: "Subject-specific questions from chosen UGC NET Subject" },
      { id: "full", name: "Full Mock Test (Paper I + Paper II)", questions: 150, timeLimit: 180, questionTypes: ["MCQ"], negativeMarking: false, marksPerQuestion: 2, negativeMarks: 0, description: "Combined 3-hour full exam simulation" }
    ],
    subjects: [
      { id: "teaching_apt", name: "Teaching & Research Aptitude", weight: 0.33, topics: ["Teaching Methods", "Research Ethics", "Communication", "Higher Ed System", "ICT"] },
      { id: "subject", name: "Subject-Specific Knowledge", weight: 0.50, topics: ["Core Subject", "Applied Knowledge", "Current Developments"] },
      { id: "reasoning", name: "Reasoning & Data Interpretation", weight: 0.17, topics: ["Logical Reasoning", "Data Interpretation", "People & Environment"] }
    ],
    difficultyDistribution: { easy: 0.20, moderate: 0.50, difficult: 0.30 },
    levels: { C: "Beginner", B: "Intermediate", A: "Advanced", "A+": "Expert", "A++": "Elite" }
  }
