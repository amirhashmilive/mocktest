/**
 * MOCKHARD — Official Examination Schedule Fallback Data System
 * ==============================================================
 * Manually maintained, high-accuracy fallback dataset for national and state
 * competitive examinations. Used when live portal scraping is blocked by anti-bot
 * protections or dynamic JavaScript rendering.
 */

const aiimsData = require('../data/aiims-exams.json');

const GENERAL_FALLBACK_EXAMS = [
  {
    id: "state-psc-2026",
    category: "state-psc",
...
// Combine all 14 AIIMS exams with general fallback exams
const FALLBACK_EXAMS = [
  ...(aiimsData.exams || []),
  ...GENERAL_FALLBACK_EXAMS
];
...
function getFallbackAIIMSDates() {
  return aiimsData.exams || [];
}

module.exports = {
  FALLBACK_EXAMS,
  getFallbackExams,
  getFallbackAIIMSDates
};
